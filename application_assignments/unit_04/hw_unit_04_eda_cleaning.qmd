...
**Missing data notes:** *Note the high percentages of missingness for cabin and age. There is also one missing observation for embarked and fare. Here we would review missing data and address any missingness due to errors/coding. However, there is nothing in the data dictionary to suggest that missing values are due to errors.*
